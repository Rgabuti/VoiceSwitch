...
- около 0,6 ГБ для рекомендуемой установки с GigaAM или около 10 ГБ для всех моделей;
...
4. В мастере выберите стартовый комплект. Для первой проверки рекомендуется
   **«Русская диктовка»**: только GigaAM, около 0,6 ГБ. Остальные модели и
...
С 08.09.2026 GigaAM выполняется через transcribe.cpp (GGUF Q8_0 на Metal): около 0,03–0,15 с на фразу вместо 0,77 с в таблице выше, память воркера около 400 МБ вместо 2 ГБ.
